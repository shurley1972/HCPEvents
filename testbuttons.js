...
define(['text!./testbuttons.html'], function( htmlString) {
	function testbuttons( params) { 
		var self = this;
		self.params = params;
//debugger;	
//debugger;
...
//debugger;				
    ...
    //componenttestbuttons.prototype.doSomething = function() { ... };
	testbuttons.prototype.schema = {
		"Params": {
			"save": true,
			"cancel": true,
	...
	ko.bindingHandlers.inittestbuttons = {
    ...
    return { viewModel: testbuttons, template: htmlString };
});
